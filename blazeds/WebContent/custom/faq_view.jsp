...
try {
	...
	if (!SLibrary.isNull(idx) && SLibrary.intValue(idx) > 0) {
		...
		hm = notic.getFAQContent(conn, SLibrary.intValue(idx));
	}else {
...
<table width="645" border="0" cellspacing="1" cellpadding="1" style="display:block;float:right">
  ...
  <tr>
    <td align="center"><img src="/images/bbs_list.jpg" style="cursor:pointer" onclick="window.location.href='?content=faq'"/></td>
  </tr>
</table>
